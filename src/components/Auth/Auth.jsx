...
import { loginValidation, passwordValidation, confirmPasswordValidation, reset, login, setVisibilityPopup } from '../../store/actions/auth'

import classes from './Auth.module.scss'

export const Auth = () => {
   const { loginInputValue, passwordInputValue, confirmPasswordInputValue, validated } = useSelector(({ auth }) => auth)
   ...
   function loginHandler() {
      dispatch(login(isRegistration, validated, loginInputValue, passwordInputValue))
   }
   ...
   return (
      <>
         ...
         <div className={classes.auth}>
            ...
            <button className={classes.cancel} onClick={visibilityHandler}>
